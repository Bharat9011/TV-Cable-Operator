...
public class TVConnection extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_t_v_connection, container, false);

        calender = view.findViewById(R.id.calender);
        month = view.findViewById(R.id.month);
        sortBY = view.findViewById(R.id.sothBy);
